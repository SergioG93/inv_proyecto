    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="../../index2.html" class="logo">
                ...
                <span class="logo-lg"><b><img src="<?php echo base_url()?>assets/template/dist/img/spotify.png">MixUp</b></span>
            </a>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                <img src="<?php echo base_url()?>assets/template/dist/img/u1.jpg" class="user-image" alt="User Image">
                                ...
                                <li class="user-body">
                                    <div class="row">
                                        <div class="col-xs-12 text-center">
                                            <a href="<?php echo base_url(); ?>auth/logout"><i class="ion-ios-undo"></i>Cerrar Sesión</a>
                                        </div>
                                    </div>
                                    <!-- /.row -->
                                </li>
